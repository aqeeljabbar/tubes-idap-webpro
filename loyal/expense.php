        ...
        <table class="table">
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <?php if ($kategori=='Makan'):?>
                        <tr>
                        <td rowspan="2"><img src="asset/cat-meal.svg"></td>
                        <td rowspan="2"></td>
                    ...
                    <?php elseif($kategori=='Investasi'): ?>
                        <tr>
                        <td rowspan="2"><img src="asset/cat-invesment.svg"></td>
                        <td rowspan="2"></td>
                        <th>Rp. <?php echo number_format($nominal); ?></th>
                        <td rowspan="2">
                            <img src="asset/expense-scd.svg">
                    ...
                    <?php elseif($kategori=='Hiburan'): ?>
                        <tr>
                        <td rowspan="2"><img src="asset/cat-hiburan.svg"></td>
                        <td rowspan="2"></td>
                        <th>Rp. <?php echo number_format($nominal); ?></th>
                        <td rowspan="2">
                            <img src="asset/expense-scd.svg">
